...
//            this.removeAllListeners();
    ...
    ,onBlur:function(f) {
        ...
        var startVal = String(this.startValue);
...
// Override to be able to dynamically set min/max/increment values of a timefield
Ext.override(Ext.form.TimeField, {
    
    reconfigure : function(minValue, maxValue, increment) {
